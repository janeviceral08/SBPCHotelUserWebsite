...
export default class Room_Infos extends Component {
    constructor(props) {
		super(props);
...
{/*  <div style={{height:'50px', width: '50px', backgroundColor: "gray", backgroundImage: `url(${this.state.img})`, backgroundPosition: 'center',
  ...
  <ul className="nav nav-tabs nav-justified" id="myTab" onClick={this.book_now} role="tablist" style={{'margin-top':'3%',border: 'none', background:' #e87b1c', 'border-radius': '1.5rem',width: '40%','float': 'right'}}>
                <li className="nav-item">
                    <a className="nav-link active" style={{width: '100px',color: '#e87b1c',  border: '2px solid #e87b1c','border-top-left-radius': '1.5rem',
                     'border-bottom-left-radius':' 1.5rem'}} id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Book</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" style={{padding: '2%',paddingTop:'8%', height: '34px', 'font-weight': 600,  color: '#fff', 'border-top-right-radius': '1.5rem',
                         'border-bottom-right-radius': '1.5rem'}} id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Now</a>
                </li>
            </ul>
        </div>
</div>
...
<br />
                                                        ...
                                                        {this.state.tags.length > 0?  <p style={{fontSize: '25px', color: 'black', fontWeight: 'bold'}}>Anemeties</p>:null }
...
<br />
                     ...
                     {this.state.tagsLandmarks.length > 0?  <p style={{fontSize: '25px', color: 'black', fontWeight: 'bold'}}>Landmarks</p>:null }
...
<br />
                     ...
                     {this.state.tagsPolicies.length > 0?  <p style={{fontSize: '25px', color: 'black', fontWeight: 'bold'}}>Fees & policies</p>:null }
...
{this.state.exercises.length > 0?<p style={{fontSize: '25px', color: 'black', fontWeight: 'bold'}}>Other Rooms Available </p>:null}
