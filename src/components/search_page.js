...
axios.post('http://localhost:5000/room_type/search_result', hotel)
.then(res => {
...
room_info_direct = (res) => {
 ...
 save_room = (info)=> {
  const save_room_info = {
   ...
   const new_saved= this.state.user_saved_rooms.concat(info.temp_id)


this.setState({saved: new_saved});
const found = this.state.user_saved_rooms.find(element => element > info.temp_id);



   axios.post('http://localhost:5000/guest_account/save_room', save_room_info)
   .then(res =>{
    
       if(res.data == 'success'){
   
var newsaved =this.state.user_saved_rooms;
newsaved.push(info.temp_id);

this.setState({user_saved_rooms:newsaved})
       }
       else{
...
<div class="tm-main-content" id="top" >
            ...
            <div class="tm-bg-primary tm-sidebar-pad">
                                    <div class="form-row">
                                       ...
                                       <div class="form-group tm-form-element tm-form-element-50 form-search" style={{backgroundColor: 'white'}}>
                                           <i class="fa fa-calendar fa-2x tm-form-element-icon"></i>
                                           <input type="text" class="form-control input-heading" value={this.props.match.params.check_in} disabled name="check_in" onChange={this.select}/>
                                       </div>
                                       <div class="form-group tm-form-element tm-form-element-50 form-search" style={{backgroundColor: 'white'}}>
                                           <i class="fa fa-calendar fa-2x tm-form-element-icon"></i>
                                           <input type="text" class="form-control input-heading" value={this.props.match.params.check_out} disabled name="check_out" onChange={this.select}/>
                                       </div>
                                       <div class="form-group tm-form-element tm-form-element-50 form-search"  style={{backgroundColor: 'white'}}>
                                           <i class="fa fa-map-marker fa-2x tm-form-element-icon"></i>
                                           <input type="text" class="form-control input-heading" value={this.props.match.params.address} disabled name="check_out" onChange={this.select}/>
                                       </div>
                                       <div class="form-group tm-form-element tm-form-element-50 form-search"  style={{backgroundColor: 'white'}}>
                                           <i class="fa fa-user-o fa-2x tm-form-element-icon"></i>
                                           <input type="text" class="form-control input-heading" value={this.props.match.params.guest+' Person'} disabled name="check_out" onChange={this.select}/>
                                       </div>
                                       <div class="form-group tm-form-element tm-form-element-50 form-search"  style={{backgroundColor: 'white'}}>
                                           <i class="fa fa-filter fa-2x tm-form-element-icon" style={{marginRight: 15}}></i>
                                           <select name="Filters" class="form-control input-heading" id="Filters" onChange={this.select} style={{width: '150px'}}>
                                                <option value="">Filters</option>
                                                <option value="7">All Rate Descrease</option>
                                                <option value="8">All Rate Increase</option>
                                                <option value="1">Daily Rate Descrease</option>
                                                <option value="2">Daily Rate Increase</option>
                                                <option value="3">Hour Rate Descrease</option>
                                                <option value="4">Hour Rate Increase</option>
                                                <option value="5">Promo Descrease</option>
                                                <option value="6">Promo Increase</option>
